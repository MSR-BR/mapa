...
PÓ MÁGICO VERSION: `v20260923.002`

PARENT: `po_magico_v20260923.001.md`

EVOLUTION SCOPE: Digital Discovery & Growth blueprint v1.0, evidence-layered SEO/index/analytics auditing, attribution integrity, conversion governance, consent gates, and paid-media readiness
...
### DIGITAL DISCOVERY & GROWTH METHODOLOGY — v1.0
...
- Previous blueprint: none.
- New blueprint: v1.0.
- Triggering project: Mapa da Pesquisa, Change 096.
- Adopted lesson: SEO, indexation, GA4, consent, and paid acquisition form one governed system, and media spend must remain blocked while attribution or conversion evidence is unreliable.
- Reason: GA4 was collecting events while a product parameter contaminated acquisition source, key events were absent, the funnel was empty, Search Console was unlinked, and two canonical public entries competed.
- Confidence: HIGH.
