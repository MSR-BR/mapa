...
| 090 | Orientação do campo do Mapa Rápido | Planejada — próxima | Placeholder passa a orientar palavras-chave ou tema com a cópia exata solicitada, sem alterar IA, validação ou avanço. |
| 091 | Login com Facebook e LinkedIn OIDC | Planejada | Google é preservado; Facebook e LinkedIn OIDC entram atrás de flags, com callbacks, privacidade e continuidade das contas homologados antes de qualquer corte. |
| 092 | Corte seguro para autenticação somente social | Planejada — bloqueada pela C91 | Cadastro, entrada e recuperação por senha saem apenas depois que todos os usuários necessários tiverem acesso por Google, Facebook ou LinkedIn sem mudança de identidade ou dados. |
...
- M10: conta com modos Aluno/Orientador alternáveis e estritamente isolados — concluído; Changes 083–089 homologadas em produção, incluindo aprovação obrigatória para o avanço do Aluno.
