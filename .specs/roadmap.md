...
| 083 | Fundação de dados para modo ativo | Validada em produção — CPD pendente | Migration 20260916163351 aplicada e registrada; backfill, auditoria, RLS, grants, Advisors, E2E e smokes aprovados. A troca permanece bloqueada. |
