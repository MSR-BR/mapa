...
| 085 | Seleção de perfil nas configurações | Validada localmente | Configurações, confirmação, concorrência versionada, idempotência, consentimento e atualização entre abas aprovados; CPD segue com a flag desligada. |
