...
PÓ MÁGICO VERSION: `v20260924.001`

PARENT: `po_magico_v20260923.002.md`

EVOLUTION SCOPE: Digital Discovery & Growth blueprint v1.1, safe analytics-taxonomy migration, historical continuity, clean-baseline gates, and reversible GA4 governance
...
### DIGITAL DISCOVERY & GROWTH METHODOLOGY — v1.1
...
- Previous blueprint: v1.0.
- New blueprint: v1.1.
- Triggering project: Mapa da Pesquisa, Change 097.
- Adopted lesson: an analytics-taxonomy repair should preserve stable event history, isolate product context under a prefix, dual-register successor dimensions, mark a dated series break, and gate comparisons behind a clean observation window.
- Reason: the validated migration removed the reserved `source` parameter without deleting historical definitions, restored a four-step funnel with real data, and proved a single controlled `project_start` carrying only the new `app_*` context.
- Confidence: HIGH.
