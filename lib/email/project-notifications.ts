...
type NotificationKind = "advisor_approved" | "advisor_comment" | "advisor_requested_changes" | "student_submitted";
...
const COPY: Record<NotificationKind, { heading: string; subject: string; summary: string }> = {
  advisor_approved: {
