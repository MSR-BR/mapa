...
PÓ MÁGICO VERSION: `v20260924.002`

PARENT: `po_magico_v20260924.001.md`

EVOLUTION SCOPE: Digital Discovery & Growth blueprint v1.2, verified search-property rollout, sitemap readback, truthful no-data baselines, and two-sided GA4 association proof
...
### DIGITAL DISCOVERY & GROWTH METHODOLOGY — v1.2
...
- Previous blueprint: v1.1.
- New blueprint: v1.2.
- Triggering project: Mapa da Pesquisa, Change 098.
- Adopted lesson: search-property rollout must separate ownership, DNS
  verification, sitemap processing, indexed-state inspection, live tests,
  report readiness, and the analytics association; unavailable metrics must
  never be rewritten as zero.
- Reason: the domain property was verified with a zone-preserving TXT, the
  transient sitemap read error cleared after independent HTTP/XML checks, URL
  inspection exposed distinct canonical/index states, and the GA4 link was
  confirmed from both products.
- Confidence: HIGH.
