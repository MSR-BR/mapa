...
export function AdvisorReviewWorkspace({ initialWorkflow, projectId, projectTitle }: Props) {
  ...
  useEffect(() => {
    ...
    setAnalyticsContext({ app_auth_state: "authenticated", app_role: "advisor", app_surface: "advisor_dashboard", ...analyticsPosition });
    trackAnalyticsEvent("advisor_review_opened", { ...analyticsPosition, app_role: "advisor" });
  }, [review]);
